<template>
    ...
    <div class="w">
      ...
      <div class="fr">
        <ul>
          <li><a href="#">我的订单</a></li>
          <li></li>
          <li class="arrow-icon"><a href="#">我的小白之家</a></li>
          <li></li>
          <li><a href="#">小白之家会员</a></li>
          <li></li>
          <li><a href="#">企业采购</a></li>
          <li></li>
    ...
    <div class="main">
      ...
      <div class="newsflash">
        <div class="news">
          ...
          <div class="news_bd">
            <ul>
              <li><a href="#"><strong>[特惠]</strong>小白小白小小白小白小白小小白小白小白小小白</a></li>
              <li><a href="#"><strong>[特惠]</strong>小白小白小小白</a></li>
              <li><a href="#"><strong>[特惠]</strong>小白小白小小白</a></li>
              <li><a href="#"><strong>[特惠]</strong>小白小白小小白</a></li>
              <li><a href="#"><strong>[特惠]</strong>小白小白小小白</a></li>
            </ul>
  ...
  <div class="glikes w">
    ...
    <div class="glikes_bd">
      <ul>
        <li>
          <img src="./upload/glikes_03.png" alt="">
        </li>
        <li></li>
        <li>
          <img src="./upload/glikes_03.png" alt="">
